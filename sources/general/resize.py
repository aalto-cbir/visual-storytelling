...
def resize_images(image_dir, output_dir, create_zip, size):
    ...
    if arguments.subset:
        print('Resizing image subset defined in {} ...'.format(arguments.subset))
        subset_ids = [line.rstrip() for line in open(arguments.subset, 'r')]
        images = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str, required=True,
                        help='directory for train_validate images')
