...
class BaselineCC:
    ...
    def _reload_model(self, state):
        ...
        self.decoder = SemanticDecoder(self.params, len(self.vocab)).to(device)
    ...
    def infer(self):
        ...
        for idx, (sequences, _, _, story_ids, _) in enumerate(self.data_loader_test):
            ...
            sampled_ids = self.decoder.generate(context_vector.squeeze(0), sequence_features, semantics_batch.to(device))
...
if __name__ == '__main__':
    ...
    # prelim parameters
    parser.add_argument('--dataset', type=str, default='vist:test',
                        help='dataset to use')
    ...
    parser.add_argument('--model_name', type=str, default='baseline_cc-ep36.pth',
                        help='model to load')
    parser.add_argument('--results_path', type=str, default='../../resources/results/',
                        help='path for storing results')
    parser.add_argument('--results_file', type=str, default='results_baseline_cc.json',
